...
create table permissao (id bigint not null auto_increment, descricao varchar(255) not null, nome varchar(255) not null, grupo_id bigint not null, grupos_id bigint not null, primary key (id)) engine=InnoDB;
...
alter table permissao add constraint FKj783a598km7qnuu561592cs4y foreign key (grupos_id) references grupo (id);
alter table permissao add constraint FKjqkmuassesey1b9y5tq1dan51 foreign key (grupo_id) references grupo (id);
